...
/**
 * Servlet implementation class UploadFileUser
 */
@WebServlet("/UploadFileUser")
public class UploadFileUser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			for (FileItem fileItem : fileItems) {
				...
				} else// Neu la control
				{
					...
					if (tentk.equals("email"))
						request.setAttribute("email", fileItem.getString("utf-8"));
					if (tentk.equals("pass"))
						request.setAttribute("pass", fileItem.getString("utf-8"));
					if (tentk.equals("repass"))
						request.setAttribute("repass", fileItem.getString("utf-8"));
				}
			}
		...
		RequestDispatcher rd= request.getRequestDispatcher("DangKyUser");
