...
/**
 * Servlet implementation class AdminHienThiAnhNext9
 */
@WebServlet("/AdminHienThiAnhNext9")
public class AdminHienThiAnhNext9 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminHienThiAnhNext9() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			Anhbo abo = new Anhbo();
			ArrayList<Anh> dsa = new ArrayList<Anh>();
			
			
			dsa = abo.getDSAnhNext9((long)amount);
